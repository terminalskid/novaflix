        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          <LegalCard
            ...
            description={
              <>
                <Paragraph>
                  Novaflix functions as a search engine and content aggregator
                ...
                <Link to="/about">Learn more about how Novaflix works</Link>
              </>
            }
          />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                Novaflix is entirely self hostable, and can be run on any
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                Novaflix is licensed under the MIT license.
                <br />
                <br />
          ...
          <LegalCard
            ...
            description={
              <Paragraph>
                ...
                <br />
                <br />
                Novaflix operates within legal boundaries and cooperates with
